...
shop_items = {"milk" : "It is at End of Aisle 1", "chocolates" : " Is in Aisle 1 section 4", "biscuits" : "Aisle 1 section 3",
...
def searching(user_input1):
	...
	if items == True:
		...
		print("not available please ask products from the above table")
		return
